...
int CHudStatusIcons::Init( int player )
{
...
int CHudStatusIcons::VidInit( int player )
{
...
int CHudStatusIcons::Draw( float flTime, int player )
{
...
//		byte   : green
//		byte   : blue
int CHudStatusIcons::MsgFunc_StatusIcon( int player, const char *pszName, int iSize, void *pbuf )
{
...
void CHudStatusIcons::EnableIcon( char *pszIconName, unsigned char red, unsigned char green, unsigned char blue )
{
	...
	{
		if ( !strcmp( m_IconList[i].szSpriteName, pszIconName ) )
			break;
	}
