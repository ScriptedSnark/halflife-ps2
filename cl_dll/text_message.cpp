...
int CHudTextMessage::Init(int player)
{
...
int CHudTextMessage::MsgFunc_TextMsg( int player, const char *pszName, int iSize, void *pbuf )
{
	...
	case HUD_PRINTNOTIFY:
		...
		Sys_sprintf( psz+1, msg_text, sstr1, sstr2, sstr3, sstr4 );
