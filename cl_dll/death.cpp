...
int CHudDeathNotice :: Init( int player )
{
...
int CHudDeathNotice :: VidInit( int player )
{
...
int CHudDeathNotice :: Draw( float flTime, int player )
{
	int x, y, r, g, b;
...
int CHudDeathNotice :: MsgFunc_DeathMsg( int player, const char *pszName, int iSize, void *pbuf )
{
	m_iFlags |= HUD_ACTIVE;
