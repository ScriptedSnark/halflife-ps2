...
int CHudAmmoSecondary :: Init( int player )
{
...
int CHudAmmoSecondary :: VidInit( int player )
{
	return 1;
}

int CHudAmmoSecondary :: Draw(float flTime, int player)
{
...
// accepts one value:
//		string:  sprite name
int CHudAmmoSecondary :: MsgFunc_SecAmmoIcon( int player, const char *pszName, int iSize, void *pbuf )
{
...
//		byte:  ammo index
//		byte:  ammo value
int CHudAmmoSecondary :: MsgFunc_SecAmmoVal( int player, const char *pszName, int iSize, void *pbuf )
{
	BEGIN_READ( pbuf, iSize );
