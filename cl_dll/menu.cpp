...
int CHudMenu :: VidInit( int player )
{
	return 1;
}

int CHudMenu :: Draw( float flTime, int player )
{
...
void CHudMenu :: SelectMenuItem( int menu_item, int player )
{
	...
	{
		char szbuf[32];
		Sys_sprintf( szbuf, "menuselect %d\n", menu_item );
		ClientCmd( szbuf );
...
int CHudMenu :: MsgFunc_ShowMenu( int player, const char *pszName, int iSize, void *pbuf )
{
